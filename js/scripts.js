  ...
  slideshow.appendChild(videoContainer);
    ...
    project6: {  
  title: 'Urbanarium',
  description: 'Urbanarium was developed within the scope of the SUSTENTAR Porto BioLab project, integrated in the Bienal’25 Fotografia do Porto, organised and produced by Ci.CLO Plataforma de Fotografia.<br><br>Developed in Porto, Portugal, Urbanarium explores the interplay between humans and nature in the contemporary city, reflecting on our role within natural systems and our capacity for transformation in the context of the Anthropocene.<br><br>Based on the Porto BioLab initiative — a future living laboratory of urban ecology — the project examines regeneration, rebalancing, and the potential of human action to coexist harmoniously with nature.<br><br>It approaches themes of pedagogy, leisure, food, habitat, philosophy, urbanism, and ecology, revealing the city as both a stage and an active participant in this dialogue.<br><br>The circular interface designed for the project fosters interaction, observation, and engagement, allowing participants to explore potential and enact transformation.<br><br><i>Curatorial support: Virgílio Ferreira and Jayne Dyer.</i>',
